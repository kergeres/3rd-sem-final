...
{
  let signuptempl = `<section id="signUpContainer">
...
document.body.innerHTML=signuptempl;
...
function appendLogin()
{
  ...
  <form>
      <input required autocomplete="email" id="signUpEmail" type="email" placeholder="Email">
      <input required autocomplete="current-password" id="signUpPassw" type="password" placeholder="Password">
      <!-- <input id="signUpPassword2" type="password" placeholder="Password"> -->
      <button onclick="home()">log in</button>
      <p onclick="appendSignup()">not registered? sign up <u>here</u></p>
  </form>
</section>`;
document.body.innerHTML=logintempl;
}

function home()
{
  let hometempl = ` <header>
...
<section class="function_buttons">
  ...
  <button class="function_button collapsible">
      ...
      <img class="icon_small icon_margin_left" src="./media/map.png">
  </button>
  <div class="content2">
      <img id="myImage" src="./img/panoramcgi.jpg" alt="map" class="mapy">
      <div class="btn-group">
          <button onclick="document.getElementById('myImage').src='./img/panoramcgi.jpg'" class="bttn">Hole
              1</button>
          <button onclick="document.getElementById('myImage').src='./img/hole2.jpg'" class="bttn">Hole 2</button>
          <button onclick="document.getElementById('myImage').src='./img/hole3-1.jpg'" class="bttn">Hole
              3</button>
      </div>
  </div>
...
document.body.innerHTML=hometempl;
